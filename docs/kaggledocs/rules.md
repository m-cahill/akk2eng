...
**[See Section 3.18 for defined terms](https://www.kaggle.com/competitions/deep-past-initiative-machine-translation/rules#18.-terms)**
...
[Deep Past Challenge - Translate Akkadian to English | Kaggle](https://www.kaggle.com/competitions/deep-past-initiative-machine-translation)
...
1. _Open Source:_ You hereby license and will license your winning Submission and the source code used to generate the Submission under a [CC-BY 4.0 Open Source Initiative-approved license](https://creativecommons.org/licenses/by/4.0/deed.en) that in no event limits commercial use of such code or model containing or depending on such code.
